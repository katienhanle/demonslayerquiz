...
export const STYLES = {
    ...
    EMBER: {
      ...
      description: `Ember slayers burn with commanding intensity. They're always rallying allies, and their voice cuts through fear. 
  They're the passionate types, igniting the battlefield with resolve and direction. In the Corps, Ember slayers often become mission captains, leading missions through spirit domains with utmost confidence.
  They value strength and decisiveness, sometimes to a fault, driving others as hard as they drive themselves.`,
    ...
    CURRENT: {
      ...
      description: `Current slayers move like moonlit water. They're gentle, perceptive, and balanced. They're always guiding others toward calm in the chaos of spirit encounters. 
  They rarely seek glory, but rather, they strengthen the Corps through understanding. When spirits rage, they see not only the danger but the sorrow beneath.`,
  ...
  They're creative, and that makes them invaluable in dynamic situations. However, their restlessness can cause friction with more grounded teammates.`,
    ...
    GALE: {
      ...
      description: `Gale slayers strike like wind blades: fast, bold, unrelenting. They trust their own instinct over hesitation and thrive in close combat. 
  ...
  They may not move quickly, but they never falter. They're grounded even in endless fog, their presence reminds others what endurance looks like.`,
